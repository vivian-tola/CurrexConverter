    ...
    >
      <div className="container mx-auto px-4 py-8">
        <div
          ...
          } rounded-lg shadow-md p-6 transition-colors duration-200`}
        >
            ...
            <div>
              <div className="mb-6">
                ...
                <input
                  ...
                  } rounded px-3 py-2 focus:outline-none focus:border-yellow-500`}
                  min="0"
                  step="any"
                />
              </div>
                    ...
                    <select
                      ...
                      className={`w-full border ${
                        darkMode
                          ? "bg-gray-700 border-gray-600 text-white"
                          : "border-gray-300"
                      }  rounded px-3 py-2 pr-10 focus:outline-none focus:border-blue-500 appearance-none`}
                    >
